...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                apiResults = NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);
                String[] jsonWeatherData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, apiResults);
        ...
        protected void onPostExecute(String[] apiResults) {
            if (apiResults != null && !apiResults.equals("")){
                for (String weatherString : apiResults) {
